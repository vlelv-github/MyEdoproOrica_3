...
function s.spcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return g:FilterCount(Card.IsAttribute,nil,ATTRIBUTE_WATER)==#g
end
function s.dspfilter(c,e,tp)
	return c:IsLevelBelow(5) and c:IsAttribute(ATTRIBUTE_WATER) and c:IsRace(RACE_WINGEDBEAST) and not c:IsCode(id)
